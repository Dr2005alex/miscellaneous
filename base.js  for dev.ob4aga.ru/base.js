...
function ajaxSend(settings) {
	...
	$.ajax({
		...
		beforeSend: function() {
			...
			if (!settings.nonshowloading) $('body').append('<span style="position:fixed; left:' + ($('body').width()/2 - 110) + 'px;top:9%;" class="loading" id="loading"><img src="./images/spinner.gif" alt="loading"/></span>').css('position', 'relative');
		},
